...
export default function TekstoviKategorijePage() {
    ...
    useEffect(() => {
        setLoading(true);
        axiosClient
            .get(`/admin/tekstovi?kategorija=${categorySlug}`)
            .then((res) => {
                setPosts(res.data);
                setKategorija({ ...res.data[0].kategorija });
                setLoading(false);
            })
    ...
    return (
        <>
            ...
            <div className="container">
                <Row>
                    <Col lg={8} md={6} sm={12}>
                        <h1>Tekstovi {kategorija?.naziv_kategorije}</h1>
                    </Col>
                    <Col lg={4} md={6} sm={12}>
